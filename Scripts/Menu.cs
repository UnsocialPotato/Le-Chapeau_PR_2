...
public class Menu : MonoBehaviourPunCallbacks
{
    ...
    public override void OnPlayerLeftRoom(Player otherPlayer)
    {
        ...
        // that's because OnJoinedRoom is only called for the client who just joined room
        // OnPLayerLeftRoom gets called for all clients in the room, so we don't need to update each one
        UpdateLobbyUI();
    }
    ...
    public void UpdateLobbyUI ()
    {
        ...
        // display all player currently in the lobby
